...
Перед запуском необходимо авторизировать ваш компьютер через их приложение, которое также необходимо установить на вашем компьютере. Ссылка на Tailscale: [Tailscale.com](https://tailscale.com/download)
